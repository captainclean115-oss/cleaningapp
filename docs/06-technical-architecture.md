...
- **Server-side compute:** Supabase Edge Functions (Deno). Functions live today: `accept-invite`, `set-employee-password`, `translate-chat`, `translate-message`, `send-sms`, `rc-inbox`, `rc-mark-read`, `get-weather`.
